...
@Component({
  selector: 'pbl-layout-grid-height-grid-example-component',
  templateUrl: './layout-grid-height.component.html',
  styleUrls: ['./layout-grid-height.component.scss'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LayoutGridHeightGridExampleComponent {
